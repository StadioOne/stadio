...
const fr = {
  ...
  users: {
    ...
    app: {
      ...
      userDetailDesc: "Informations et actions sur l'utilisateur de l'app",
      ban: "Bannir",
      unban: "Débannir",
      delete: "Supprimer le compte",
      banConfirmTitle: "Bannir cet utilisateur ?",
      banConfirmDesc: "L'utilisateur {{email}} ne pourra plus se connecter à l'application.",
      deleteConfirmTitle: "Supprimer ce compte ?",
      deleteConfirmDesc: "Le compte de {{email}} sera définitivement supprimé. Cette action est irréversible.",
...
const en = {
  ...
  users: {
    ...
    app: {
      ...
      userDetailDesc: "App user information and actions",
      ban: "Ban",
      unban: "Unban",
      delete: "Delete account",
      banConfirmTitle: "Ban this user?",
      banConfirmDesc: "{{email}} will no longer be able to sign in to the app.",
      deleteConfirmTitle: "Delete this account?",
      deleteConfirmDesc: "{{email}}'s account will be permanently deleted. This action cannot be undone.",
